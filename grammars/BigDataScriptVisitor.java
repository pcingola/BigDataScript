...
public interface BigDataScriptVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code typePrimitiveString}
	...
	/**
	 * Visit a parse tree produced by the {@code typePrimitiveVoid}
	 * labeled alternative in {@link BigDataScriptParser#type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code typePrimitiveReal}
	 * labeled alternative in {@link BigDataScriptParser#type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code typePrimitiveBool}
	 * labeled alternative in {@link BigDataScriptParser#type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code typePrimitiveInt}
	 * labeled alternative in {@link BigDataScriptParser#type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
