...
public class StatementInclude extends Block {
	...
	protected void parse(ParseTree tree) {
		...
		if(parentFile != null && !includedFile.isAbsolute()  ) 
			includedFile=new File(parentFile.getParent(),includedFilename);
		// -------------
	...
	protected void typeCheck(Scope scope, CompilerMessages compilerMessages) {
		if (!isValidFileName(includedFilename)) 
			compilerMessages.add(this, "For loop condition must be a bool expression", MessageType.ERROR);
