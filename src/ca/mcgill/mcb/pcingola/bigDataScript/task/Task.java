...
public class Task implements BigDataScriptSerialize {
	...
	protected List<Task> dependencies; // Task that need to finish before this one is executed
	...
	protected synchronized DependencyState dependencyState(Set<Task> tasksVisited) {
		...
		if (dependencies == null) return DependencyState.OK; // No dependencies? => we are ready to execute
