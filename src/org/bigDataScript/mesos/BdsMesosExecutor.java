...
import org.bigDataScript.executioner.NotifyTaskState;
import org.bigDataScript.executioner.PidParser;
import org.bigDataScript.osCmd.Cmd;
import org.bigDataScript.osCmd.CmdLocal;
...
public class BdsMesosExecutor implements Executor, NotifyTaskState, PidParser {
	...
	@Override
	public void taskFinished(Task task, org.bigDataScript.task.TaskState taskState) {
